//For (3) 0x63f6037d3e9d51ad865056BF7792029803b6eEfD with WETH/USDC
...
interface ILendingPool {
    ...
    function liquidationCall( //เรียกใช้งานเมื่อ health factor < 1
...
interface IERC20 { //ชนิดของ token USDT,AAVE,WBTC etc.
...
interface IWETH is IERC20 { //Subclass ของ IERC20
...
interface IUniswapV2Pair {
     ...
     **/
    function swap( //ไว้ใช้ในการทำ Flash Loan
        uint256 amount0Out,
        uint256 amount1Out,
        address to,
        bytes calldata data
...
;
    ...
    function operate() external {
        ...
        //check health factor ว่าเป็น 1 หรือเปล่า
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool1, uint256 reserve_WETH_Pool1, ) = uniswapV2Pair_WETH_USDC.getReserves(); // Pool1 WBTC/USDT
