...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        uint remainBalance = WBTC.balanceOf(address(this));
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), remainBalance);
        uint amountOut_WETH = getAmountOut(remainBalance, reserve_WBTC_Pool2, reserve_WETH_Pool2);
